    ...
    const providers = await Provider.aggregate([
      {
        $match: {
          ...
          service_type: serviceType.TV_SUBSCRIPTION,
        },
      },
      {
        $lookup: {
...
// @route    POST /api/v1/tv/merchant-verify
// @access   Public
